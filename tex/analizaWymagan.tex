...
% 	    \rowcolors{1}{}{lightblue}
	    \begin{tabular}{| l | l | l | l | l |}%\toprule
		    Lp. & Nazwa  & Priorytet & Ryzyko & Nazwa użytkownika \\
		    1. & Zarządzanie użytkownikami & wysoki & niskie & administrator \\
		    1.1 & Dodawanie użytkownika & wysokie & niskie & adminstrator \\
		    1.2 & Edycja danych użytkownika & wysokie & niskie & adminstrator \\ 	
		    1.3 & Usuwanie danych użytkownika & wysokie &niskie & administrator \\
	    \end{tabular}
	\end{center}
\end{table}
